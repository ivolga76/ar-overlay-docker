      ...
      <section className="max-w-4xl mx-auto px-4 pb-16">
        {ratings.length === 0 ? (
          <DarkPanel className="text-center py-12">
            <p className="text-text-muted">Нет завершённых турниров 2×2 в этом сезоне.</p>
          </DarkPanel>
        ) : (
              ...
              <tbody>
                {ratings.map((r) => (
                  <tr
                    ...
                    className="border-b border-[rgba(234,224,205,0.03)] hover:bg-[rgba(255,0,128,0.02)] transition-colors"
                  >
                    <td className="py-3 px-4">
                      <span className={`
                        ...
                        ${r.rank === 1 ? 'text-accent-gold crt-glow-gold' :
                          ...
                          r.rank === 3 ? 'text-accent-magenta' : 'text-text-muted'}
                      `}>
                        {r.rank}
                      </span>
                    </td>
