...
**React + Vite** приложение для стрим-оверлея турниров «Битва за Респект» по игре **Arc Raiders**. Проводится стримером [Денисом Блимом](https://twitch.tv/denisblim) на Twitch и YouTube.
